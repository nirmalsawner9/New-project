        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 text-blue-100 max-w-3xl mx-auto">
              Discover luxury properties, family homes, and investment opportunities 
              in California&apos;s most desirable locations.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Expert Market Knowledge</h3>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                We offer competitive commission rates and transparent pricing with no hidden fees.
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                We provide personalized attention and support throughout your entire real estate journey.
              </p>
            </div>
          </div>
        </div>
